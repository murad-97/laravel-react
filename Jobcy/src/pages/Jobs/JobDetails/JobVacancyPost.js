...
const JobVacancyPost = (props) => {
  ...
  return (
    <React.Fragment>
      {jobs.filter(fullTimeJobdetails => fullTimeJobdetails.id !== props.job.id).map((fullTimeJobdetails, key) => (
        <div
          key={key}
          className={
            ...
            <Row className="align-items-center">
              <Col md={2}>
                <div className="text-center mb-4 mb-md-0">
                  ...
                  <img
                      src={`http://127.0.0.1:8000/storage/company_img/${fullTimeJobdetails.company.img1}`}
                      alt="CompanyImage"
